 ...
 */
export default class SlCombobox extends ShoelaceElement implements ShoelaceFormControl {
  ...
  render() {
    ...
    // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment, @typescript-eslint/no-unsafe-call, no-new
